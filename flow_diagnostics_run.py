...
def flow_diagnostics_run(image1_path, image2_path, params=None):
    ...
    # Read images
    Im1 = io.imread(image1_path)
    Im2 = io.imread(image2_path)
...
if __name__ == "__main__":
    # Example usage
    # image1_path = "White_Oval_1.tif"
    # image2_path = "White_Oval_2.tif"
    # image1_path = "wall_jet_1.tif"
    # image2_path = "wall_jet_2.tif"
    image1_path = "vortex_pair_particles_1.tif"
    image2_path = "vortex_pair_particles_2.tif"
