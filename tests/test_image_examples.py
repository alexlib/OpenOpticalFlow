...
def test_vortex_pair_basic():
    ...
    # Store results for use in the main function
    test_vortex_pair_basic.results = (u, v, vorticity, img1_small, img2_small)
...
def test_wall_jet_basic():
    ...
    # Store results for use in the main function
    test_wall_jet_basic.results = (u, v, vorticity, img1_small, img2_small)
...
def test_white_oval_basic():
    ...
    # Store results for use in the main function
    test_white_oval_basic.results = (u, v, vorticity, img1_small, img2_small)
...
def test_2d_vortices_basic():
    ...
    # Store results for use in the main function
    test_2d_vortices_basic.results = (u, v, vorticity, img1_small, img2_small)


if __name__ == "__main__":
    # Run the tests and visualize the results
    print("Testing vortex pair images...")
    test_vortex_pair_basic()
    u, v, vorticity, img1, img2 = test_vortex_pair_basic.results
